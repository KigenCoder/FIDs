  ...
  export default {
    ...
    methods: {
      monthSelected: function () {
        ...
        this.$store.commit('weekly_data/monthIdMutation', this.month_id)

        this.$store.commit('weekly_data/refreshPage', true)
      ...
      yearSelected: function () {
        this.$store.commit('weekly_data/yearNameMutation', this.year_name)
